...
uint32_t ppmServoToRange(uint32_t signal, uint32_t inMin = 1010, uint32_t inMax = 1970, uint32_t outMin = 0, uint32_t outMax = 1023); // Function to evaluate the ppm signal from a servo
